...
flags.DEFINE_string(
    "bert_config_file", "./pre_train_model/chinese_L-12_H-768_A-12/bert_config.json",
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "reason", "The name of the task to train.")

flags.DEFINE_string("vocab_file", "./pre_train_model/chinese_L-12_H-768_A-12/vocab.txt",
...
flags.DEFINE_string(
    "init_checkpoint", "./pre_train_model/chinese_L-12_H-768_A-12/bert_model.ckpt",
...
class ReasonProcessor(DataProcessor):
  """Processor for the MRPC data set (GLUE version)."""
...
def main(_):
  ...
  if FLAGS.do_train:
    ...
    #         "label_ids": tf.placeholder(shape=[None, 128], dtype=tf.int32),
    #         "segment_ids": tf.placeholder(shape=[None, 128], dtype=tf.int32),
    #     }
    #     return tf.estimator.export.ServingInputReceiver(inputs, inputs)
    #
    # estimator._export_to_tpu = False
    # export_dir = estimator.export_savedmodel(export_dir_base=FLAGS.output_dir,
